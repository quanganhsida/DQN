...
class MyAgent:
    def __init__(self, state_size, action_size):
        ...
        #Update weight of target_network = main_network
...
#Definition of state_size and action_size
...
for ep in range(n_episodes):
    ...
    for t in range(n_timesteps):
        ...
        action = my_agent.make_dicision(state)
        ...
        if terminal:
            print('Episode: ', ep+1, ' reach terminal with reward = ', ep_rewards)
            break
